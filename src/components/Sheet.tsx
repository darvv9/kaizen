...
export function Sheet({ open, title, onClose, z = LAYER.sheet, footer, children }: Props) {
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            <motion.div
              /* Teto medido a partir da status bar, não um 88% chutado: por mais
                 campo que tenha dentro, o sheet nunca sobe até o relógio. */
              ...
              /* Só o cabeçalho arrasta. Se o painel inteiro arrastasse, rolar a
                 lista de dentro puxaria o sheet junto. */
            ...
            >
              ...
              {footer && (
                <div className="shrink-0 border-t border-white/[0.07] bg-ink-950/40 px-5 pb-[calc(var(--safe-bottom)+1rem)] pt-3">
                  {footer}
                </div>
              )}
            </motion.div>
